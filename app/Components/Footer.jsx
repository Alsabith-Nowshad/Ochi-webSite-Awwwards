...
const Footer = () => {
  return (
    <div className="w-full h-[100vh] gap-24 md:flex bg-zinc-900 p-20">
      <div className="w-[700px] h-[85vh] flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[5vw] font-semibold  uppercase leading-[13vh] -mb-10">
            Eye-
          </h1>
          <h1 className="text-[5vw] font-semibold uppercase leading-[13vh] -mb-10">
            Opening
